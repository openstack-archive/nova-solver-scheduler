...
# Note(Yathi): Adding additional options here so that other scheduler
# drivers like Solver Scheduler can share the opts
scheduler_driver_opts = [
    ...
    cfg.FloatOpt('ram_allocation_ratio',
               default=1.5,
               help='Virtual ram to physical ram allocation ratio which '
                    'affects all ram filters. This configuration specifies a '
                    'global ratio for RamFilter. For AggregateRamFilter, it '
                    'will fall back to this configuration value if no '
                    'per-aggregate setting found.'),
    cfg.FloatOpt('ram_weight_multiplier',
               default=1.0,
               help='Multiplier used for weighing ram and also used in '
                    'Solver Scheduler, by the pluggable solvers as a '
                    'ram cost multiplier.  Negative numbers mean to '
                    'stack vs spread.'),
    cfg.FloatOpt('cpu_allocation_ratio',
        ...
        help='Virtual CPU to physical CPU allocation ratio which affects '
             ...
             'This option is also used in Solver Scheduler for the '
