...
cinder_opts = [
    ...
    cfg.BoolOpt('cinder_cross_az_attach',
                ...
                help='Allow attach between instance and volume in different '
                     'availability zones.'),
    cfg.StrOpt('cinder_admin_user',
               default=None,
               help='Keystone Cinder account username'),
    cfg.StrOpt('cinder_admin_password',
               default=None,
               help='Keystone Cinder account password'),
    cfg.StrOpt('cinder_admin_tenant_name',
               default='service',
               help='Keystone Cinder account tenant name'),
    cfg.StrOpt('cinder_auth_uri',
               default=None,
...
def cinderadminclient():
    # Note(xinyuan): in case admin context is needed,
    # this provides a method to use cinder admin credentials.
    c = cinder_client.Client(CONF.cinder_admin_user,
                             CONF.cinder_admin_password,
                             project_id=CONF.cinder_admin_tenant_name,
                             auth_url=CONF.cinder_auth_uri,
                             insecure=CONF.cinder_api_insecure,
                             retries=CONF.cinder_http_retries,
                             cacert=CONF.cinder_ca_certificates_file)
    return c
